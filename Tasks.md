...
| 5 | H | Server login + user identity (Anonymous + Google; Apple skipped) | ⚠️ BLOCKED | Bundle 4 gate ✅ + user prework ✅ |
...
**Status:** ⚠️ BLOCKED — Google Sign-In Unity Plugin is not present in the project, so Google account picker/link validation cannot pass yet. Implementation is wired and anonymous/AuthConfig/profile scaffolding compiles.
